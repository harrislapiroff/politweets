"""
Django settings for politweetalyzer project.
...
SECRET_KEY = '888y61@gpuj_%nfe2jm2ctc9#1cs_f$9!+lhtfrbj7q(*)15en'
...
ROOT_URLCONF = 'politweetalyzer.urls'
...
WSGI_APPLICATION = 'politweetalyzer.wsgi.application'
...
PROPUBLICA_API_KEY = os.environ.get('PROPUBLICA_API_KEY', None)
PROPUBLICA_API_BASE = os.environ.get('PROPUBLICA_API_BASE', None)
